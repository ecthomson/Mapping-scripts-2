...
echo "CCHF_S mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i /home2/HCV2/Uganda/Scripts/Ref_db/CCHF_S_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> CCHF_S_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' CCHF_S_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat CCHF_S_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Ref_db/CCHF_S_phylo_refs.fa>CCHF_S_Consensus_plus_refs.fasta
mafft CCHF_S_Consensus_90.fasta > CCHF_S_Consensus_90_aligned.fasta
mafft CCHF_S_Consensus_plus_refs.fasta > CCHF_S_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt CCHF_S_Consensus_90_aligned.fasta > CCHF_S_consensus_tree_$$
fasttree -nt CCHF_S_Consensus_plus_refs_aligned.fasta > CCHF_S_consensus_plus_refs_tree_$$
clear
