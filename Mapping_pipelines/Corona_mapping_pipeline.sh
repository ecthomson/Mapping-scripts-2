...
echo "Corona mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Corona/Corona_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Corona_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Corona_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Corona_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Corona/Corona_phylo_refs.fa >Corona_Consensus_plus_refs.fasta
mafft Corona_Consensus_90.fasta > Corona_Consensus_90_aligned.fasta
mafft Corona_Consensus_plus_refs.fasta > Corona_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Corona_Consensus_90_aligned.fasta > Corona_consensus_tree_$$
fasttree -nt Corona_Consensus_plus_refs_aligned.fasta > Corona_consensus_plus_refs_tree_$$
clear
