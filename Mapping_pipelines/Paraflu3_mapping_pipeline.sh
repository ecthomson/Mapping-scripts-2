...
echo "Paraflu3 mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Paraflu3/Paraflu3_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Paraflu3_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Paraflu3_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Paraflu3_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Paraflu3/Paraflu3_phylo_refs.fa >Paraflu3_Consensus_plus_refs.fasta
mafft Paraflu3_Consensus_90.fasta > Paraflu3_Consensus_90_aligned.fasta
mafft Paraflu3_Consensus_plus_refs.fasta > Paraflu3_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Paraflu3_Consensus_90_aligned.fasta > Paraflu3_consensus_tree_$$
fasttree -nt Paraflu3_Consensus_plus_refs_aligned.fasta > Paraflu3_consensus_plus_refs_tree_$$
clear
