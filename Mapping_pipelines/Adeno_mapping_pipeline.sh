...
echo "Adeno mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Adeno/Adeno_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Adeno_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Adeno_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Adeno_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Adeno/Adeno_phylo_refs.fa >Adeno_Consensus_plus_refs.fasta
mafft Adeno_Consensus_90.fasta > Adeno_Consensus_90_aligned.fasta
mafft Adeno_Consensus_plus_refs.fasta > Adeno_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Adeno_Consensus_90_aligned.fasta > Adeno_consensus_tree_$$
fasttree -nt Adeno_Consensus_plus_refs_aligned.fasta > Adeno_consensus_plus_refs_tree_$$
clear
