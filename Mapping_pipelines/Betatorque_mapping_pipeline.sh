#### Betatorque pipeline for mapping 
...
echo "Betatorque mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Betatorque/Betatorque_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Betatorque_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Betatorque_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Betatorque_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Betatorque/Betatorque_phylo_refs.fa >Betatorque_Consensus_plus_refs.fasta
mafft Betatorque_Consensus_90.fasta > Betatorque_Consensus_90_aligned.fasta
mafft Betatorque_Consensus_plus_refs.fasta > Betatorque_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Betatorque_Consensus_90_aligned.fasta > Betatorque_consensus_tree_$$
fasttree -nt Betatorque_Consensus_plus_refs_aligned.fasta > Betatorque_consensus_plus_refs_tree_$$
clear
