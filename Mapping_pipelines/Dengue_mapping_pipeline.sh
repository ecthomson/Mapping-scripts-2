...
echo "Dengue mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Dengue/Dengue_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Dengue_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Dengue_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Dengue_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Dengue/Dengue_phylo_refs.fa >Dengue_Consensus_plus_refs.fasta
mafft Dengue_Consensus_90.fasta > Dengue_Consensus_90_aligned.fasta
mafft Dengue_Consensus_plus_refs.fasta > Dengue_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Dengue_Consensus_90_aligned.fasta > Dengue_consensus_tree_$$
fasttree -nt Dengue_Consensus_plus_refs_aligned.fasta > Dengue_consensus_plus_refs_tree_$$
clear
