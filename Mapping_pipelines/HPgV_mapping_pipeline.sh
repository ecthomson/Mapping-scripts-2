...
echo "HPgV mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HPgV/HPgV_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> HPgV_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat HPgV_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HPgV/HPgV_phylo_refs.fa >>HPgV_Consensus_plus_refs.fasta
mafft HPgV_Consensus_90.fasta > HPgV_Consensus_90_aligned.fasta
mafft HPgV_Consensus_plus_refs.fasta > HPgV_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt HPgV_Consensus_90_aligned.fasta > hpgv_consensus_tree_$$
fasttree -nt HPgV_Consensus_plus_refs_aligned.fasta > hpgv_consensus_plus_refs_tree_$$
clear
