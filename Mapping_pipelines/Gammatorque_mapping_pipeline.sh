#### Gammatorque pipeline for mapping 
...
echo "Gammatorque mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Gammatorque/Gammatorque_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Gammatorque_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Gammatorque_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Gammatorque_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Gammatorque/Gammatorque_phylo_refs.fa >Gammatorque_Consensus_plus_refs.fasta
mafft Gammatorque_Consensus_90.fasta > Gammatorque_Consensus_90_aligned.fasta
mafft Gammatorque_Consensus_plus_refs.fasta > Gammatorque_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Gammatorque_Consensus_90_aligned.fasta > Gammatorque_consensus_tree_$$
fasttree -nt Gammatorque_Consensus_plus_refs_aligned.fasta > Gammatorque_consensus_plus_refs_tree_$$
clear
