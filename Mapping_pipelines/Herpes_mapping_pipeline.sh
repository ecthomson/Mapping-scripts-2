...
echo "Herpes mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Herpes/Herpes_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Herpes_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Herpes_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Herpes_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Herpes/Herpes_phylo_refs.fa >Herpes_Consensus_plus_refs.fasta
mafft Herpes_Consensus_90.fasta > Herpes_Consensus_90_aligned.fasta
mafft Herpes_Consensus_plus_refs.fasta > Herpes_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Herpes_Consensus_90_aligned.fasta > Herpes_consensus_tree_$$
fasttree -nt Herpes_Consensus_plus_refs_aligned.fasta > Herpes_consensus_plus_refs_tree_$$
clear
