...
echo "HIV2 mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HIV2/HIV2_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> HIV2_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' HIV2_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat HIV2_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HIV2/HIV2_phylo_refs.fa >HIV2_Consensus_plus_refs.fasta
mafft HIV2_Consensus_90.fasta > HIV2_Consensus_90_aligned.fasta
mafft HIV2_Consensus_plus_refs.fasta > HIV2_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt HIV2_Consensus_90_aligned.fasta > HIV2_consensus_tree_$$
fasttree -nt HIV2_Consensus_plus_refs_aligned.fasta > HIV2_consensus_plus_refs_tree_$$
clear
