...
CREATE_KMERS-FQ-T -i /home/db/Genomes/Virus/HCV_Refs.fa -1 $fq1.fastq -c 1 -p 1 -v >> $fq1.geno
...
fq1=`echo $file|awk '{print $1}' `;
fq2=`echo $file|awk '{print $2}' `;
tanoti -i $fq1.fastq -r $(less $fq1.newbest) -p 0 -u 0 -o $fq1-$(less $fq1.newbest|tr -d '\r').sam -m 50
done < tanlist-$$
