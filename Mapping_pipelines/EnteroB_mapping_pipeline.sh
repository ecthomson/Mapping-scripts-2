...
echo "EnteroB mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/EnteroB/EnteroB_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> EnteroB_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' EnteroB_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat EnteroB_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/EnteroB/EnteroB_phylo_refs.fa >EnteroB_Consensus_plus_refs.fasta
mafft EnteroB_Consensus_90.fasta > EnteroB_Consensus_90_aligned.fasta
mafft EnteroB_Consensus_plus_refs.fasta > EnteroB_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt EnteroB_Consensus_90_aligned.fasta > EnteroB_consensus_tree_$$
fasttree -nt EnteroB_Consensus_plus_refs_aligned.fasta > EnteroB_consensus_plus_refs_tree_$$
clear
