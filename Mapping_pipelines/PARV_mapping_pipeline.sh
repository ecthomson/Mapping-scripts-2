...
echo "PARV mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/PARV/PARV_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> PARV_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' PARV_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat PARV_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/PARV/PARV_phylo_refs.fa >PARV_Consensus_plus_refs.fasta
mafft PARV_Consensus_90.fasta > PARV_Consensus_90_aligned.fasta
mafft PARV_Consensus_plus_refs.fasta > PARV_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt PARV_Consensus_90_aligned.fasta > PARV_consensus_tree_$$
fasttree -nt PARV_Consensus_plus_refs_aligned.fasta > PARV_consensus_plus_refs_tree_$$
clear
