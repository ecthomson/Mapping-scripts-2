...
echo "Mumps mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Mumps/Mumps_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Mumps_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Mumps_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Mumps_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Mumps/Mumps_phylo_refs.fa >Mumps_Consensus_plus_refs.fasta
mafft Mumps_Consensus_90.fasta > Mumps_Consensus_90_aligned.fasta
mafft Mumps_Consensus_plus_refs.fasta > Mumps_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Mumps_Consensus_90_aligned.fasta > Mumps_consensus_tree_$$
fasttree -nt Mumps_Consensus_plus_refs_aligned.fasta > Mumps_consensus_plus_refs_tree_$$
clear
