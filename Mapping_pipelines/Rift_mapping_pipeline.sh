...
echo "Rift mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Rift/Rift_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Rift_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Rift_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Rift_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Rift/Rift_phylo_refs.fa >Rift_Consensus_plus_refs.fasta
mafft Rift_Consensus_90.fasta > Rift_Consensus_90_aligned.fasta
mafft Rift_Consensus_plus_refs.fasta > Rift_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Rift_Consensus_90_aligned.fasta > Rift_consensus_tree_$$
fasttree -nt Rift_Consensus_plus_refs_aligned.fasta > Rift_consensus_plus_refs_tree_$$
clear
