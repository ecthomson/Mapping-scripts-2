...
echo "YFV mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/YFV/YFV_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> YFV_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' YFV_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat YFV_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/YFV/YFV_phylo_refs.fa >YFV_Consensus_plus_refs.fasta
mafft YFV_Consensus_90.fasta > YFV_Consensus_90_aligned.fasta
mafft YFV_Consensus_plus_refs.fasta > YFV_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt YFV_Consensus_90_aligned.fasta > YFV_consensus_tree_$$
fasttree -nt YFV_Consensus_plus_refs_aligned.fasta > YFV_consensus_plus_refs_tree_$$
clear
