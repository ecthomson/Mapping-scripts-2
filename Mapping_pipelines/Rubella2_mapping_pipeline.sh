...
echo "Rubella2 mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Rubella2/Rubella2_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Rubella2_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Rubella2_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Rubella2_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Rubella2/Rubella2_phylo_refs.fa >Rubella2_Consensus_plus_refs.fasta
mafft Rubella2_Consensus_90.fasta > Rubella2_Consensus_90_aligned.fasta
mafft Rubella2_Consensus_plus_refs.fasta > Rubella2_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Rubella2_Consensus_90_aligned.fasta > Rubella2_consensus_tree_$$
fasttree -nt Rubella2_Consensus_plus_refs_aligned.fasta > Rubella2_consensus_plus_refs_tree_$$
clear
