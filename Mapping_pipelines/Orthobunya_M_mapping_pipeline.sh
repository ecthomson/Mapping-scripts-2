...
echo "Orthobunya_M mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Orthobunya/Orthobunya_Refs_M.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Orthobunya_M_Consensus_90.fasta
echo "Aligning consensus sequences..."
##]CHANGE TO THE 120 FILE HERE
cat Orthobunya_M_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Orthobunya/Orthobunya_Refs_M.fa Orthobunya_M_Refs.fa>>Orthobunya_M_Consensus_plus_refs.fasta
mafft Orthobunya_M_Consensus_90.fasta > Orthobunya_M_Consensus_90_aligned.fasta
mafft Orthobunya_M_Consensus_plus_refs.fasta > Orthobunya_M_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Orthobunya_M_Consensus_90_aligned.fasta > Orthobunya_M_consensus_tree_$$
fasttree -nt Orthobunya_M_Consensus_plus_refs_aligned.fasta > Orthobunya_M_consensus_plus_refs_tree_$$
clear
