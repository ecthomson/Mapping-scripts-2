...
echo "HAV mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HAV/HAV_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> HAV_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' HAV_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat HAV_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HAV/HAV_phylo_refs.fa >HAV_Consensus_plus_refs.fasta
mafft HAV_Consensus_90.fasta > HAV_Consensus_90_aligned.fasta
mafft HAV_Consensus_plus_refs.fasta > HAV_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt HAV_Consensus_90_aligned.fasta > HAV_consensus_tree_$$
fasttree -nt HAV_Consensus_plus_refs_aligned.fasta > HAV_consensus_plus_refs_tree_$$
clear
