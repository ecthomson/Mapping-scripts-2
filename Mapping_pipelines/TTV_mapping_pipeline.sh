...
echo "TTV mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/TTV/TTV_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> TTV_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' TTV_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat TTV_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/TTV/TTV_phylo_refs.fa >TTV_Consensus_plus_refs.fasta
mafft TTV_Consensus_90.fasta > TTV_Consensus_90_aligned.fasta
mafft TTV_Consensus_plus_refs.fasta > TTV_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt TTV_Consensus_90_aligned.fasta > TTV_consensus_tree_$$
fasttree -nt TTV_Consensus_plus_refs_aligned.fasta > TTV_consensus_plus_refs_tree_$$
clear
