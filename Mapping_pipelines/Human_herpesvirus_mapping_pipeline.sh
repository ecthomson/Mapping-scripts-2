#### Human herpes pipeline for mapping 
#### Emma Thomson 23/7/19
...
CREATE_KMERS-FQ-T -i /home2/herpes2/Uganda/Scripts/Ref_db/herpes_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
cat herpes_Consensus_90.fasta /home2/herpes2/Uganda/Scripts/Ref_db/herpes_phylo_refs.fa>herpes_Consensus_plus_refs.fasta
