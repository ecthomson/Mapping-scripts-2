...
echo "HIV1 mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HIV1/HIV1_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> HIV1_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' HIV1_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat HIV1_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HIV1/HIV1_phylo_refs.fa >HIV1_Consensus_plus_refs.fasta
mafft HIV1_Consensus_90.fasta > HIV1_Consensus_90_aligned.fasta
mafft HIV1_Consensus_plus_refs.fasta > HIV1_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt HIV1_Consensus_90_aligned.fasta > HIV1_consensus_tree_$$
fasttree -nt HIV1_Consensus_plus_refs_aligned.fasta > HIV1_consensus_plus_refs_tree_$$
clear
