...
CREATE_KMERS-FQ-T -i /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Orthobunya/Orthobunya_Refs_S.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
cat Orthobunya_S_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Orthobunya/Orthobunya_S_Refs.fa>>Orthobunya_S_Consensus_plus_refs.fasta
