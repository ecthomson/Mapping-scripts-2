...
echo "HBV mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HBV/HBV_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> HBV_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' HBV_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat HBV_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HBV/HBV_phylo_refs.fa >HBV_Consensus_plus_refs.fasta
mafft HBV_Consensus_90.fasta > HBV_Consensus_90_aligned.fasta
mafft HBV_Consensus_plus_refs.fasta > HBV_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt HBV_Consensus_90_aligned.fasta > HBV_consensus_tree_$$
fasttree -nt HBV_Consensus_plus_refs_aligned.fasta > HBV_consensus_plus_refs_tree_$$
clear
