...
echo "Orthobunya_S mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Orthobunya/S/Orthobunya_S_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Orthobunya_S_Consensus_90.fasta
echo "Aligning consensus sequences..."
##]CHANGE TO THE 120 FILE HERE
cat Orthobunya_S_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Orthobunya/S/Orthobunya_S_phylo_refs.fa>Orthobunya_S_Consensus_plus_refs.fasta
mafft Orthobunya_S_Consensus_90.fasta > Orthobunya_S_Consensus_90_aligned.fasta
mafft Orthobunya_S_Consensus_plus_refs.fasta > Orthobunya_S_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Orthobunya_S_Consensus_90_aligned.fasta > Orthobunya_S_consensus_tree_$$
fasttree -nt Orthobunya_S_Consensus_plus_refs_aligned.fasta > Orthobunya_S_consensus_plus_refs_tree_$$
clear
