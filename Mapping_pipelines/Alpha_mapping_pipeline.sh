...
echo "Alpha mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Alpha/Alpha_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Alpha_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Alpha_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Alpha_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Alpha/Alpha_phylo_refs.fa >Alpha_Consensus_plus_refs.fasta
mafft Alpha_Consensus_90.fasta > Alpha_Consensus_90_aligned.fasta
mafft Alpha_Consensus_plus_refs.fasta > Alpha_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Alpha_Consensus_90_aligned.fasta > Alpha_consensus_tree_$$
fasttree -nt Alpha_Consensus_plus_refs_aligned.fasta > Alpha_consensus_plus_refs_tree_$$
clear
