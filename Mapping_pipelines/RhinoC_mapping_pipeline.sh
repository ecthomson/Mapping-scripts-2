...
echo "RhinoC mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/RhinoC/RhinoC_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> RhinoC_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' RhinoC_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat RhinoC_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/RhinoC/RhinoC_phylo_refs.fa >RhinoC_Consensus_plus_refs.fasta
mafft RhinoC_Consensus_90.fasta > RhinoC_Consensus_90_aligned.fasta
mafft RhinoC_Consensus_plus_refs.fasta > RhinoC_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt RhinoC_Consensus_90_aligned.fasta > RhinoC_consensus_tree_$$
fasttree -nt RhinoC_Consensus_plus_refs_aligned.fasta > RhinoC_consensus_plus_refs_tree_$$
clear
