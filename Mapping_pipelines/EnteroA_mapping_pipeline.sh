...
echo "EnteroA mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/EnteroA/EnteroA_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> EnteroA_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' EnteroA_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat EnteroA_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/EnteroA/EnteroA_phylo_refs.fa >EnteroA_Consensus_plus_refs.fasta
mafft EnteroA_Consensus_90.fasta > EnteroA_Consensus_90_aligned.fasta
mafft EnteroA_Consensus_plus_refs.fasta > EnteroA_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt EnteroA_Consensus_90_aligned.fasta > EnteroA_consensus_tree_$$
fasttree -nt EnteroA_Consensus_plus_refs_aligned.fasta > EnteroA_consensus_plus_refs_tree_$$
clear
