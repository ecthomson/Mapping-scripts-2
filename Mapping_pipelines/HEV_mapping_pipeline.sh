...
echo "HEV mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HEV/HEV_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> HEV_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' HEV_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat HEV_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/HEV/HEV_phylo_refs.fa >HEV_Consensus_plus_refs.fasta
mafft HEV_Consensus_90.fasta > HEV_Consensus_90_aligned.fasta
mafft HEV_Consensus_plus_refs.fasta > HEV_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt HEV_Consensus_90_aligned.fasta > HEV_consensus_tree_$$
fasttree -nt HEV_Consensus_plus_refs_aligned.fasta > HEV_consensus_plus_refs_tree_$$
clear
