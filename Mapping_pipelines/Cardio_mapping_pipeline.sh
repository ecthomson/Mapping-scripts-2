...
echo "Cardio mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Cardio/Cardio_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Cardio_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Cardio_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Cardio_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Cardio/Cardio_phylo_refs.fa >Cardio_Consensus_plus_refs.fasta
mafft Cardio_Consensus_90.fasta > Cardio_Consensus_90_aligned.fasta
mafft Cardio_Consensus_plus_refs.fasta > Cardio_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Cardio_Consensus_90_aligned.fasta > Cardio_consensus_tree_$$
fasttree -nt Cardio_Consensus_plus_refs_aligned.fasta > Cardio_consensus_plus_refs_tree_$$
clear
