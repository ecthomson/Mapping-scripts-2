...
echo "Measles mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i  /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Measles/Measles_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> Measles_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' Measles_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat Measles_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Mapping_pipelines/Measles/Measles_phylo_refs.fa >Measles_Consensus_plus_refs.fasta
mafft Measles_Consensus_90.fasta > Measles_Consensus_90_aligned.fasta
mafft Measles_Consensus_plus_refs.fasta > Measles_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt Measles_Consensus_90_aligned.fasta > Measles_consensus_tree_$$
fasttree -nt Measles_Consensus_plus_refs_aligned.fasta > Measles_consensus_plus_refs_tree_$$
clear
