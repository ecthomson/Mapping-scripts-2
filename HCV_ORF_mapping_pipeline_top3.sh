...
CREATE_KMERS-FQ-T -i /home1/Acute_HCV_UK/Fastq/Runs/refs_ORF/Chris/HCV_Refs_ORF_CD.fasta -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
fq1=`echo $file|awk '{print $1}' `;
fq2=`echo $file|awk '{print $2}' `;
tanoti -i $fq1.fastq $fq2.fastq -r /home1/Acute_HCV_UK/Fastq/Runs/refs_ORF/Chris/$(less $fq1.newbest1).fa -p 1 -u 0 -o $fq1-$(less $fq1.newbest1|tr -d '\r').sam -m 50
tanoti -i $fq1.fastq $fq2.fastq -r /home1/Acute_HCV_UK/Fastq/Runs/refs_ORF/Chris/$(less $fq1.newbest2).fa -p 1 -u 0 -o $fq1-$(less $fq1.newbest2|tr -d '\r').sam -m 50
tanoti -i $fq1.fastq $fq2.fastq -r /home1/Acute_HCV_UK/Fastq/Runs/refs_ORF/Chris/$(less $fq1.newbest3).fa -p 1 -u 0 -o $fq1-$(less $fq1.newbest3|tr -d '\r').sam -m 50
done < tanlist-$$
...
cat Consensus_90.fasta /home1/Acute_HCV_UK/Fastq/Runs/refs_ORF/Chris/HCV_Refs_ORF_CD.fasta>>Consensus_plus_refs.fasta
