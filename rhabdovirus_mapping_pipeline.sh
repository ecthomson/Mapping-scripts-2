#### Rhabdovirus pipeline for mapping 
...
echo "Rhabdovirus mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i /home2/HCV2/Uganda/Scripts/Ref_db/rhabdovirus_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
ConsensusSorter samstats-$$ allconfile-$$ 90 >> rhabdovirus_Consensus_90.fasta
sed -i 's/Cannot open output\. Sending the output to STDOUT//g' rhabdovirus_Consensus_90.fasta
echo "Aligning consensus sequences..."
cat rhabdovirus_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Ref_db/rhabdovirus_phylo_refs.fa>rhabdovirus_Consensus_plus_refs.fasta
mafft rhabdovirus_Consensus_90.fasta > rhabdovirus_Consensus_90_aligned.fasta
mafft rhabdovirus_Consensus_plus_refs.fasta > rhabdovirus_Consensus_plus_refs_aligned.fasta
echo "Building nj tree for quick look - to check for contamination..."
fasttree -nt rhabdovirus_Consensus_90_aligned.fasta > rhabdovirus_consensus_tree_$$
fasttree -nt rhabdovirus_Consensus_plus_refs_aligned.fasta > rhabdovirus_consensus_plus_refs_tree_$$
clear
