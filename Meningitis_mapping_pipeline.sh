...
echo "Meningitis mapping pipeline has started...
"
...
CREATE_KMERS-FQ-T -i /home2/HCV2/Uganda/Scripts/Ref_db/meningitis_ck_refs.fa -1 $fq1.fastq -2 $fq2.fastq  -c 1 -p 1 -v >> $fq1.geno
...
#ConsensusSorter samstats-$$ allconfile-$$ 90 >> meningitis_Consensus_90.fasta
echo "Aligning consensus sequences..."
#cat meningitis_Consensus_90.fasta /home2/HCV2/Uganda/Scripts/Ref_db/meningitis_phylo_refs.fa/meningitis_Refs_unix.fa>>meningitis_Consensus_plus_refs.fasta
#mafft meningitis_Consensus_90.fasta > meningitis_Consensus_90_aligned.fasta
#mafft meningitis_Consensus_plus_refs.fasta > meningitis_Consensus_plus_refs_aligned.fasta
#echo "Building nj tree for quick look - to check for contamination..."
#fasttree -nt meningitis_Consensus_90_aligned.fasta > meningitis_consensus_tree_$$
#fasttree -nt meningitis_Consensus_plus_refs_aligned.fasta > meningitis_consensus_plus_refs_tree_$$
clear
echo "Analysis complete. Output is *.sam, samstats, allconfile (all consensus sequences)"
